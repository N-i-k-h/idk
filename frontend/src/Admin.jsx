...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchDateHistory = async () => {
      try {
        const response = await fetch("https://idkba.onrender.com/admin/date-history", {
          method: "GET",
          headers: {
    ...
    const fetchAvailableDates = async () => {
      try {
        const response = await fetch("https://idkba.onrender.com/admin/available-dates", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      ...
      if (adminId) {
        try {
          const response = await fetch("https://idkba.onrender.com/admin/profile", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
    ...
    const fetchDashboardData = async () => {
      try {
        const response = await fetch("https://idkba.onrender.com/admin/dashboard", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
  ...
  useEffect(() => {
    const fetchFacultyList = async () => {
      if (selectedBranch) {
        try {
          const response = await fetch(`https://idkba.onrender.com/admin/faculty-list?branch=${selectedBranch}&page=${currentPage}`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
  ...
  const handleConfirm = async () => {
    try {
      const response = await fetch("https://idkba.onrender.com/admin/add-date", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
  ...
  const handleResetDates = async () => {
    try {
      const response = await fetch("https://idkba.onrender.com/admin/reset-dates", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
